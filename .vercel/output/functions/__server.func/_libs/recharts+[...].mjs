...
var _excluded$20 = ["children"], _excluded2$9 = ["children"];
...
var isSingleChildEqual = function isSingleChildEqual(nextChild, prevChild) {
	...
	if (!(0, import_isNil.default)(nextChild) && !(0, import_isNil.default)(prevChild)) {
		...
		var _ref2 = prevChild.props || {}, prevChildren = _ref2.children, prevProps = _objectWithoutProperties$20(_ref2, _excluded2$9);
...
var Symbols = function Symbols(_ref) {
	...
	var props = _objectSpread$38(_objectSpread$38({}, _objectWithoutProperties$17(_ref, _excluded$17)), {}, {
		type,
		size,
		sizeType
	});
...
var _excluded$12 = ["valueAccessor"], _excluded2$7 = [
	"data",
	"dataKey",
	"clockWise",
	"id",
...
function LabelList(_ref) {
	...
	var data = restProps.data, dataKey = restProps.dataKey, clockWise = restProps.clockWise, id = restProps.id, textBreakAll = restProps.textBreakAll, others = _objectWithoutProperties$12(restProps, _excluded2$7);
...
function typeGuardSectorProps(option, props) {
	...
	return _objectSpread$16(_objectSpread$16(_objectSpread$16({}, props), option), {}, {
		cx,
		cy
	});
}
		...
		},
		{
			...
			value: function renderSectorsStatically(sectors) {
				...
				return sectors.map(function(entry, i) {
					...
					var props = _objectSpread$15(_objectSpread$15(_objectSpread$15(_objectSpread$15({}, baseProps), {}, { cornerRadius: parseCornerRadius(cornerRadius) }, entry), adaptEventsOfChild(_this2.props, entry, i)), {}, {
					...
					return /*#__PURE__*/ import_react.createElement(RadialBarSector, _extends$13({}, props, { key: "sector-".concat(i) }));
				});
			}
		},
		{
			...
			value: function renderSectorsWithAnimation() {
				...
				return /*#__PURE__*/ import_react.createElement(es6_default, {
					...
					var stepData = data.map(function(entry, index) {
						...
						return _objectSpread$15(_objectSpread$15({}, entry), {}, { endAngle: interpolator(t) });
					});
					return /*#__PURE__*/ import_react.createElement(Layer, null, _this3.renderSectorsStatically(stepData));
				});
			}
		...
		},
		{
			...
			value: function renderBackground(sectors) {
				...
				return sectors.map(function(entry, i) {
					...
					var props = _objectSpread$15(_objectSpread$15(_objectSpread$15(_objectSpread$15(_objectSpread$15({ cornerRadius: parseCornerRadius(cornerRadius) }, rest), {}, { fill: "#eee" }, background), backgroundProps), adaptEventsOfChild(_this4.props, entry, i)), {}, {
						index: i,
...
_defineProperty$18(RadialBar, "displayName", "RadialBar");
_defineProperty$18(RadialBar, "defaultProps", {
	angleAxisId: 0,
	radiusAxisId: 0,
	minPointSize: 0,
	hide: false,
...
_defineProperty$18(RadialBar, "getComposedData", function(_ref2) {
	...
	return {
		data: displayedData.map(function(entry, index) {
			...
			return _objectSpread$15(_objectSpread$15(_objectSpread$15(_objectSpread$15({}, entry), backgroundSector), {}, {
				payload: entry,
...
//#endregion
export { Legend as _, LineChart as a, Area as c, Bar as d, RadialBar as f, Tooltip as g, ResponsiveContainer as h, BarChart as i, Line as l, Cell as m, AreaChart as n, YAxis as o, Pie as p, PieChart as r, XAxis as s, RadialBarChart as t, CartesianGrid as u };
